package dev.kiarielinus.sudoku.computationlogic

import dev.kiarielinus.sudoku.domain.Difficulty
import dev.kiarielinus.sudoku.domain.SudokuNode
...
internal fun SudokuPuzzle.unsolve(): SudokuPuzzle {
    val remove = ((boundary * boundary) - (boundary * boundary * difficulty.modifier)).toInt()
